...
<section class="main background-light">
    <div class="container pt-5 col-md-7 col-12">
        ...
        <form action="/login" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    <label>ニックネーム</label>
                    <input class="form-control" type="text" name="nickname" placeholder="ニックネーム" maxlength="50">
                </div>
                <div class="form-group">
                    <label>メールアドレス</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="password_confirm" placeholder="パスワード確認用" maxlength="50">
                </div>
                <button class="btn btn-warning mb-5" type="submit">登録する</button>
        </form>
    </div>
</section>
