    ...
    <div class="container pt-5 col-md-7 col-12">
        ...
        <form action="/user/edit" method="post" autocomplete="off">
            ...
            <div class="form-group">
                <label>ユーザー名</label>
                <input class="form-control" type="text" name="name" value="{{$user->name}}" maxLength='50'>
            </div>
            <div class="form-group">
                <label>ニックネーム</label>
                <input class="form-control" type="text" name="nickname" value="{{$user->nickname}}" maxlength="50">
            </div>
            <div class="form-group">
                <label>メールアドレス</label>
                <input class="form-control" type="email" name="email" value="{{$user->email}}" maxlength="50">
            </div>
            <div class="form-group">
                <label>パスワード</label>
                <input class="form-control" type="password" name="password"  maxlength="50">
            </div>
            <button class="btn btn-warning" type="submit">更新する</button>
        </form>
    </div>
</section>
